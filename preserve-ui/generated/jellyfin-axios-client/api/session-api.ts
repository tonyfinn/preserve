...
// @ts-ignore
import { ClientCapabilities } from '../model';
// @ts-ignore
import { GeneralCommand } from '../model';
// @ts-ignore
import { GeneralCommandType } from '../model';
// @ts-ignore
import { NameIdPair } from '../model';
// @ts-ignore
import { PlayCommand } from '../model';
// @ts-ignore
import { PlaystateCommand } from '../model';
// @ts-ignore
...
export const SessionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        postFullCapabilities: async (clientCapabilities: ClientCapabilities, id?: string, options: any = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            const nonString = typeof clientCapabilities !== 'string';
            const needsSerialization = nonString && configuration && configuration.isJsonMime
                ? configuration.isJsonMime(localVarRequestOptions.headers['Content-Type'])
                : nonString;
            localVarRequestOptions.data =  needsSerialization
                ? JSON.stringify(clientCapabilities !== undefined ? clientCapabilities : {})
                : (clientCapabilities || "");
        ...
        sendFullGeneralCommand: async (sessionId: string, generalCommand: GeneralCommand, options: any = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            const nonString = typeof generalCommand !== 'string';
            const needsSerialization = nonString && configuration && configuration.isJsonMime
                ? configuration.isJsonMime(localVarRequestOptions.headers['Content-Type'])
                : nonString;
            localVarRequestOptions.data =  needsSerialization
                ? JSON.stringify(generalCommand !== undefined ? generalCommand : {})
                : (generalCommand || "");
